...
export default function SetupWizard() {
    ...
    const OnSubmitData = () => {
        ...
        if (wizardData?.sampleLoaded === 'manual') {
            ...
            const config = {
                headers: {
                    Authorization: `Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjA5MTQ5ZDhkOGJiZDc3ZTQwMTdiNTNiYjg1NTVhODUyODViODI4NzYifQ..aX8AhgADWJu2ErTuHJbiN715xMsV3XWoo0443j5djT4X9N9Y3meoq40LMkUeuhvJb66sBbQNdEYG_FIZkij5xTWPBew9jfxY7YsdurLxOM-akRmMF7uxPSVJRpUIwA1qESbZeQjhH-3KsKVg3ty_azRzXB-DN_IJYWpuAWWUbMPNfv25ZXKoH9Dwob-koCBZUYsMv8rs-_-EaMRQ-TyDenRhWQyVCjzu3e6_3ga6BR0Z0HsBZ-55JW1KjKJpWxPrGpy09xPhG4ohYMNgmZFik75mR3PfUAh5rRSPfpy6EgJ-xnFarvHQK_vo2HeydpNuZPq0B_VfsoKjN0juEQWbsA`,
                },
            }
            axios
