...
import {
    GithubComKaytuIoKaytuEngineServicesIntegrationApiEntityCredentialType,
    SourceType,
} from '../../../../../../../api/api'
...
export default function NewPrincipal({
    ...
    const {
    ...
    } = useIntegrationApiV1CredentialsAzureCreate(
        {
            ...
            type: GithubComKaytuIoKaytuEngineServicesIntegrationApiEntityCredentialType.CredentialTypeManualAzureEntraId,
        },
        {},
        false
    )
    ...
    const {
        ...
        currentWorkspace || '',
        {
            ...
            azureConfig: {
                ...
                credentialType:
                    GithubComKaytuIoKaytuEngineServicesIntegrationApiEntityCredentialType.CredentialTypeManualAzureEntraId,
            },
        },
        {},
        false
