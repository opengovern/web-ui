...
interface IuseAuthApiV1DashboardsTokenCreateState {
    isLoading: boolean
    isExecuted: boolean
    response?: GithubComKaytuIoKaytuEnginePkgAuthApiGenerateDashboardTokenResponse
 ...
 * URL:
 */
export const useAuthApiV1DashboardsTokenCreate = (
    ...
    const [state, setState] = useState<IuseAuthApiV1DashboardsTokenCreateState>(
        {
            isLoading: true,
            isExecuted: false,
        }
    ...
    const sendRequest = (
        ...
        try {
            ...
            api.auth
                .apiV1DashboardsTokenCreate(reqparamsSignal)
                .then((resp) => {
                    setState({
                        ...state,
                        error: undefined,
