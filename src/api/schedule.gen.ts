...
interface IuseScheduleApiV0CheckupTriggerListState {
    isLoading: boolean
    isExecuted: boolean
    response?: void
    error?: any
...
export const useScheduleApiV0CheckupTriggerList = (
    ...
    const [state, setState] =
        useState<IuseScheduleApiV0CheckupTriggerListState>({
            isLoading: true,
            isExecuted: false,
        })
    ...
    const sendRequest = () => {
        ...
        try {
            api.schedule
                .apiV0CheckupTriggerList(params)
                .then((resp) => {
                    setState({
                        ...state,
                        error: undefined,
