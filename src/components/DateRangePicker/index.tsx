    ...
    return (
        <div className="relative inline-flex flex-col text-left">
            ...
            <div {...groupProps} ref={ref} className="flex group h-9">
                <div className="flex bg-white dark:bg-gray-900 dark:text-gray-50 border border-gray-300 group-hover:border-gray-400 transition-colors rounded-l-md pr-5 group-focus-within:border-kaytu-600 group-focus-within:group-hover:border-kaytu-600 p-1 relative">
